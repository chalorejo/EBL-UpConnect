...
<head>
    ...
    <style>
        ...
        table { width: 100%; margin: 10px auto 10px auto; border-collapse: collapse; }
        th, td { padding: 10px; border: 1px solid #ccc; text-align: center; }
        th { background-color: #f2f2f2; }
        .student-group { border: 1px solid #ddd; margin-bottom: 40px; padding: 10px; border-radius: 8px; }
        .student-header { background-color:rgba(76, 175, 79, 0.38);; padding: 10px; border-radius: 6px; font-weight: bold; }
        h3{ font-size: 3rem; color: #00573F; margin-bottom: 40px; font-family: 'Optima'; font-weight: normal; text-align: center; margin-top: -10px;}
        th:first-child, td:first-child { width: 300px; }
    </style>
</head>
<body>
    <!-- NAVBAR-->   
